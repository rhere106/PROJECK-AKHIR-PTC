    ...
    <main>
        <div class="container">
            <div class="left">
                ...
                <a class="option" href="registAdmin.php">• Admin</a>
            </div>
            <div class="right">
                <div class="content">
                    <h3>DAFTAR DOSEN</h3>
                        ...
                        if (!is_array($dosen_data) || empty($dosen_data)) {
                            ...
                            foreach ($dosen_data as $dosen) {
                                if (
                                    ...
                                    echo "<td>
                                        <a href='#' onclick='showEditModal(\"{$dosen['id']}\", \"{$dosen['username']}\", \"{$dosen['gender']}\", \"{$dosen['nuptk']}\", \"{$dosen['homebase']}\", \"{$dosen['nama_matakuliah']}\", \"{$dosen['email']}\")' class='detail-link'><i class='fa-solid fa-pen-to-square'></i></a> |
                                        <a href='daftarDosen.php?delete_id={$dosen['id']}' class='detail-link'><i class='fa-solid fa-trash'></i></a>
                                    </td>";
                                    echo "</tr>";
                                    $no++;
                                }
